...
function SignUp() {
    ...
    const onSumbit = (data: EmailPasswordRegisterParams) => mutate(data)

    return (
        <div className={"w-full h-full flex items-center justify-center"}>
            <Paper sx={{minWidth: 420}} elevation={4} className={"p-8 flex flex-col items-center gap-3"}>
                <Typography variant={"h6"}>
                    Sign up
                </Typography>
                <form onSubmit={handleSubmit(onSumbit)} className={"w-full flex flex-col items-center gap-6"}>
                    { error && (
                        <motion.div
